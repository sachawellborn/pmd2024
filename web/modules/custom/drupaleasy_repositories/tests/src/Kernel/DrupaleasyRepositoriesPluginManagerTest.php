...
final class DrupaleasyRepositoriesPluginManagerTest extends KernelTestBase {
  ...
  /**
   * Test creating and instance of the .yml remote plugin.
   *
   * @covers DrupaleasyRepositoresPluginManager::class
   * @test
   */
  public function testYmlRemoteInstance(): void {
    ...
    $this->assertInstanceOf('Drupal\drupaleasy_repositories\DrupaleasyRepositories\DrupaleasyRepositoriesPluginBase', $example_instance, 'Plugin type no.');
    ...
    $this->assertTrue($plugin_def['label'] == 'Remote .yml file', 'The label value is not correct.');
  }
